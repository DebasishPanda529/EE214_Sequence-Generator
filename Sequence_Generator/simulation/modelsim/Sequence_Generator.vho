...
-- state_out[0]	=>  Location: PIN_6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- state_out[1]	=>  Location: PIN_13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- state_out[2]	=>  Location: PIN_113,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- state_out[3]	=>  Location: PIN_14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- state_out[4]	=>  Location: PIN_12,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \dut_input[1]~clkctrl_INCLK_bus\ : std_logic_vector(3 DOWNTO 0);
SIGNAL \dut_input[0]~clkctrl_INCLK_bus\ : std_logic_vector(3 DOWNTO 0);
...
SIGNAL \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|design_hash_reg[0]~22_combout\ : std_logic;
...
SIGNAL \dut_input[0]~clkctrl_outclk\ : std_logic;
SIGNAL \dut_instance|add_instance|D[1]~1_combout\ : std_logic;
SIGNAL \dut_input[1]~feeder_combout\ : std_logic;
SIGNAL \dut_input[1]~clkctrl_outclk\ : std_logic;
SIGNAL \dut_instance|add_instance|ff2|Q~q\ : std_logic;
SIGNAL \dut_instance|add_instance|D[2]~0_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|ff1|Q~q\ : std_logic;
SIGNAL \dut_instance|add_instance|ff3|Q~q\ : std_logic;
SIGNAL \altera_internal_jtag~TDO\ : std_logic;
SIGNAL \dut_instance|add_instance|D\ : std_logic_vector(2 DOWNTO 0);
...
SIGNAL \dut_instance|add_instance|ff3|ALT_INV_Q~q\ : std_logic;
SIGNAL \ALT_INV_altera_internal_jtag~TCKUTAPclkctrl_outclk\ : std_logic;
SIGNAL \ALT_INV_dut_input[1]~clkctrl_outclk\ : std_logic;
...
\dut_input[1]~clkctrl_INCLK_bus\ <= (vcc & vcc & vcc & dut_input(1));

\dut_input[0]~clkctrl_INCLK_bus\ <= (vcc & vcc & vcc & dut_input(0));
...
\dut_instance|add_instance|ff3|ALT_INV_Q~q\ <= NOT \dut_instance|add_instance|ff3|Q~q\;
\ALT_INV_altera_internal_jtag~TCKUTAPclkctrl_outclk\ <= NOT \altera_internal_jtag~TCKUTAPclkctrl_outclk\;
\ALT_INV_dut_input[1]~clkctrl_outclk\ <= NOT \dut_input[1]~clkctrl_outclk\;
...
-- pragma translate_on
PORT MAP (
	i => \dut_instance|add_instance|ff3|ALT_INV_Q~q\,
	devoe => ww_devoe,
	o => ww_state_out(0));
...
PORT MAP (
	...
	datad => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|irsr_reg[4]~10_combout\,
...
-- Equation(s):
-- \datau[0]~0_combout\ = (\io~q\ & ((\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\ & ((!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_udr~0_combout\))) # 
...
\datau[0]~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[0]~1_combout\ = (\datau[0]~0_combout\ & (!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\ & (!\dut_instance|add_instance|ff3|Q~q\))) # (!\datau[0]~0_combout\ & (((datau(0)))))
...
PORT MAP (
	...
	datab => \dut_instance|add_instance|ff3|Q~q\,
	datac => datau(0),
	datad => \datau[0]~0_combout\,
...
\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|design_hash_reg[0]~22\ : fiftyfivenm_lcell_comb
-- pragma translate_off
GENERIC MAP (
	lut_mask => "1111000000000000",
	sum_lutc_input => "datac")
...
-- pragma translate_on
PORT MAP (
	dataa => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|design_hash_reg[0]~22_combout\,
...
-- Equation(s):
-- \shift_reg~1_combout\ = (\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\ & (!\io~q\ & !\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_udr~0_combout\))
...
\data[0]~feeder\ : fiftyfivenm_lcell_comb
-- Equation(s):
...
-- Equation(s):
-- \shift_reg~0_combout\ = (!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\ & (!\io~q\ & \u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_udr~0_combout\))
...
\dut_input[0]~clkctrl\ : fiftyfivenm_clkctrl
-- pragma translate_off
GENERIC MAP (
	clock_type => "global clock",
	ena_register_mode => "none")
-- pragma translate_on
PORT MAP (
	inclk => \dut_input[0]~clkctrl_INCLK_bus\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	outclk => \dut_input[0]~clkctrl_outclk\);

-- Location: LCCOMB_X26_Y34_N12
\dut_instance|add_instance|D[1]~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|D[1]~1_combout\ = (!\dut_instance|add_instance|ff2|Q~q\ & (\dut_instance|add_instance|ff1|Q~q\ $ (\dut_instance|add_instance|ff3|Q~q\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|add_instance|ff1|Q~q\,
	datac => \dut_instance|add_instance|ff2|Q~q\,
	datad => \dut_instance|add_instance|ff3|Q~q\,
	combout => \dut_instance|add_instance|D[1]~1_combout\);

-- Location: LCCOMB_X31_Y27_N0
\dut_input[1]~feeder\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_input[1]~feeder_combout\ = data(1)
...
PORT MAP (
	datad => data(1),
	combout => \dut_input[1]~feeder_combout\);
...
\dut_input[1]~clkctrl\ : fiftyfivenm_clkctrl
-- pragma translate_off
GENERIC MAP (
	clock_type => "global clock",
	ena_register_mode => "none")
-- pragma translate_on
PORT MAP (
	inclk => \dut_input[1]~clkctrl_INCLK_bus\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	outclk => \dut_input[1]~clkctrl_outclk\);

-- Location: FF_X26_Y34_N13
\dut_instance|add_instance|ff2|Q\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
-- pragma translate_on
PORT MAP (
	clk => \dut_input[0]~clkctrl_outclk\,
	d => \dut_instance|add_instance|D[1]~1_combout\,
	clrn => \ALT_INV_dut_input[1]~clkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \dut_instance|add_instance|ff2|Q~q\);

-- Location: LCCOMB_X26_Y34_N10
\dut_instance|add_instance|D[2]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|D[2]~0_combout\ = (!\dut_instance|add_instance|ff1|Q~q\ & \dut_instance|add_instance|ff2|Q~q\)
...
-- pragma translate_on
PORT MAP (
	datac => \dut_instance|add_instance|ff1|Q~q\,
	datad => \dut_instance|add_instance|ff2|Q~q\,
	combout => \dut_instance|add_instance|D[2]~0_combout\);

-- Location: FF_X26_Y34_N11
\dut_instance|add_instance|ff1|Q\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \dut_input[0]~clkctrl_outclk\,
	d => \dut_instance|add_instance|D[2]~0_combout\,
	clrn => \ALT_INV_dut_input[1]~clkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \dut_instance|add_instance|ff1|Q~q\);

-- Location: LCCOMB_X26_Y34_N16
\dut_instance|add_instance|D[0]\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|D\(0) = (\dut_instance|add_instance|ff3|Q~q\ & (!\dut_instance|add_instance|ff1|Q~q\ & \dut_instance|add_instance|ff2|Q~q\)) # (!\dut_instance|add_instance|ff3|Q~q\ & ((!\dut_instance|add_instance|ff2|Q~q\)))
...
PORT MAP (
	dataa => \dut_instance|add_instance|ff1|Q~q\,
	datac => \dut_instance|add_instance|ff3|Q~q\,
	datad => \dut_instance|add_instance|ff2|Q~q\,
	combout => \dut_instance|add_instance|D\(0));

-- Location: FF_X26_Y34_N17
\dut_instance|add_instance|ff3|Q\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \dut_input[0]~clkctrl_outclk\,
	d => \dut_instance|add_instance|D\(0),
	clrn => \ALT_INV_dut_input[1]~clkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \dut_instance|add_instance|ff3|Q~q\);
